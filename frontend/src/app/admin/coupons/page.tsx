        ...
        <div style={{ background: 'white', padding: '24px', borderRadius: '16px', boxShadow: '0 4px 12px rgba(0,0,0,0.03)', marginBottom: '32px' }}>
          ...
          <form onSubmit={addCoupon} style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'flex-end' }}>
            ...
            <div style={{ flex: 1, minWidth: '150px' }}>
              ...
              <input type="date" value={validUntil} onChange={e => setValidUntil(e.target.value)} required style={{ width: '100%', padding: '10px', borderRadius: '8px', border: '1px solid #cbd5e1' }} />
            </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={5} style={{ padding: '24px', textAlign: 'center' }}>No coupons found.</td></tr>
              ) : coupons.map(c => (
                <tr key={c._id} style={{ borderBottom: '1px solid #e2e8f0' }}>
                  ...
                  <td style={{ padding: '16px 24px' }}>{new Date(c.validUntil).toLocaleDateString()}</td>
